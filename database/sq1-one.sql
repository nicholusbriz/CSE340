...
CREATE TABLE IF NOT EXISTS public.comments (
    ...
    CONSTRAINT fk_comment_inventory FOREIGN KEY (inv_id) 
...
CREATE INDEX IF NOT EXISTS idx_comments_inv_id ON public.comments (inv_id);
CREATE INDEX IF NOT EXISTS idx_comments_account_id ON public.comments (account_id);

-- Insert sample comments using your actual account IDs
INSERT INTO public.comments (inv_id, account_id, comment_text)
VALUES 
    (1, 9, 'This car looks amazing! Love the color!'),
    (2, 10, 'I have always wanted a Batmobile!'),
    (3, 11, 'Perfect for my dog grooming business!'),
    (1, 12, 'Great price for this vehicle!'),
    (2, 9, 'The Batmobile is my dream car!'),
    (3, 10, 'This would be perfect for my business!');
